...
public class AutofitHelper {
     ...
     */
    private void autofit(TextPaint paint, float minTextSize, float maxTextSize,
        ...
        TextView view = mTextView;

        int targetWidth = mAdapter.getMaxWidthOfView(view);
        if (targetWidth <= 0) {
            return;
        }
    ...
    private void autofit() {
        ...
        mIsAutofitting = true;
        autofit(mPaint, mMinTextSize, mMaxTextSize, mMaxLines, mPrecision);
